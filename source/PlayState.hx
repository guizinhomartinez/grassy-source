...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'sunlight':
				dialogue = CoolUtil.coolTextFile(Paths.txt('sunlight/dialog'));
			case 'photosynthesis':
				dialogue = CoolUtil.coolTextFile(Paths.txt('photosynthesis/dialog'));
			case 'lawnmower':
				dialogue = CoolUtil.coolTextFile(Paths.txt('lawnmower/dialog'));
		}
		...
		switch(SONG.stage)
		{
			...
			case 'background-cool':
				{
					defaultCamZoom = 0.9;
					curStage = 'background-cool';
					var bg:FlxSprite = new FlxSprite(-700, -500).loadGraphic(Paths.image('grass/bggcool'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);

					var stageFront:FlxSprite = new FlxSprite(-750, 400).loadGraphic(Paths.image('grass/bgggsupercool'));
		...
		healthBar.createFilledBar(0xFF66FF33, 0xFF0091FF);
		// healthBar
		add(healthBar);
